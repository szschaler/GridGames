...
public class GlobalCellStateSpecImpl extends MinimalEObjectImpl.Container implements GlobalCellStateSpec
{
   ...
   * @ordered
   */
  protected EList<StateParamSpec> params;
   ...
   * @generated
   */
  public EList<StateParamSpec> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<StateParamSpec>(StateParamSpec.class, this, GridGamePackage.GLOBAL_CELL_STATE_SPEC__PARAMS);
    }
    return params;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case GridGamePackage.GLOBAL_CELL_STATE_SPEC__PARAMS:
        getParams().clear();
        getParams().addAll((Collection<? extends StateParamSpec>)newValue);
        return;
      case GridGamePackage.GLOBAL_CELL_STATE_SPEC__STATES:
        getStates().clear();
