...
entryRuleGlobalCellStateSpec returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getGlobalCellStateSpecRule()); }
	 iv_ruleGlobalCellStateSpec=ruleGlobalCellStateSpec 
	 { $current=$iv_ruleGlobalCellStateSpec.current; } 
	 EOF 
;

// Rule GlobalCellStateSpec
ruleGlobalCellStateSpec returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='states' 
...
entryRuleVarRefValue returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getVarRefValueRule()); }
	 iv_ruleVarRefValue=ruleVarRefValue 
	 { $current=$iv_ruleVarRefValue.current; } 
	 EOF 
;

// Rule VarRefValue
ruleVarRefValue returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
(
    ...
    { 
        $current = $this_LocalFieldInitialisations_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_FieldInitialisationsRef_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleFieldInitialisationsRef returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getFieldInitialisationsRefRule()); }
	 iv_ruleFieldInitialisationsRef=ruleFieldInitialisationsRef 
	 { $current=$iv_ruleFieldInitialisationsRef.current; } 
	 EOF 
;

// Rule FieldInitialisationsRef
ruleFieldInitialisationsRef returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='init' 
