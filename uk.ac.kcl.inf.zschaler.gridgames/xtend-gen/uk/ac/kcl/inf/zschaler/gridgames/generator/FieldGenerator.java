...
public class FieldGenerator extends CommonGenerator {
  ...
  public CharSequence generateFieldModel() {
    ...
    if (true) {
      ...
      _builder_1.newLine();
      _builder_1.append("\t\t\t\t\t");
      _builder_1.append("handleStateChange ();");
      _builder_1.newLine();
      _builder_1.append("\t\t\t\t");
      ...
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("private void handleStateChange () {");
      _builder_1.newLine();
      _builder_1.append("\t\t");
      _builder_1.newLine();
      _builder_1.append("\t");
    ...
    if (_exists) {
      ...
      _builder_2.append("private CellContext getContextAt (int x, int y) {");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("return new CellContext(x, y);");
      _builder_2.newLine();
      _builder_2.append("}");
      _builder_2.newLine();
      _builder_2.newLine();
      _builder_2.append("private class CellContext {");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("private ArrayList<Cell> al = new ArrayList<> (8);");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("public CellContext (int x, int y) {");
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("for (int dx = -1; dx <= 1; dx ++) {");
      _builder_2.newLine();
      _builder_2.append("\t\t\t");
      _builder_2.append("for (int dy = -1; dy <= 1; dy++) {");
      _builder_2.newLine();
      _builder_2.append("\t\t\t\t");
      _builder_2.append("if (((dx != 0) || (dy != 0)) && ");
      _builder_2.newLine();
      _builder_2.append("\t\t\t\t    ");
      _builder_2.append("((x + dx >= 0) && (x + dx < width)) &&");
      _builder_2.newLine();
      _builder_2.append("\t\t\t\t    ");
      _builder_2.append("((y + dy >= 0) && (y + dy < height)) &&");
      _builder_2.newLine();
      _builder_2.append("\t\t\t\t    ");
      _builder_2.append("(field[x + dx][y + dy] != null)) {");
      _builder_2.newLine();
      _builder_2.append("\t\t\t\t\t");
      _builder_2.append("al.add (field[x + dx][y + dy]);");
      _builder_2.newLine();
      _builder_2.append("\t\t\t\t");
      _builder_2.append("}");
      _builder_2.newLine();
