...
public class BorderingMineCell extends Cell {
	private int numberVariable;
	
	public BorderingMineCell(int number) {
	...
	public static class HiddenCellState extends CellState {
	 ...
	 public static class DiscoveredCellState extends CellState {
		...
		public Component formatUIRepresentation(Cell cOwner, JButton jb, JLabel jl) {
			jl.setOpaque (false);
			jl.setText ("" + ((BorderingMineCell) cOwner).numberVariable);
			return jl;
		}
	...
	@Override
	public boolean isBorderingMine() {
		return true;
	}
