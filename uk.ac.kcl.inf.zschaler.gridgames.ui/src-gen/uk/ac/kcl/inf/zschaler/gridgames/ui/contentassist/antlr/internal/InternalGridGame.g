...
ruleTransitionTriggerSpec
	...
	:
(
{ before(grammarAccess.getTransitionTriggerSpecAccess().getMouseTriggerParserRuleCall()); }
	ruleMouseTrigger
{ after(grammarAccess.getTransitionTriggerSpecAccess().getMouseTriggerParserRuleCall()); }
)
